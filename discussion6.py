...
###############################################################################
    def load_results(self, table):
        ...
        for item in items:
            ...
            values_3 = item[3]
            output[horse_name] = {
                                  header[1] : float(values_1),
                                  header[2] : float(values_2),
                                  header[3] : float(values_3)
                                  }
...
###############################################################################
    ...
    def horse_personal_best(self):
        ...
        for horse in self.race_dict:
            out[horse] = self.horse_fastest_race(horse)
...
###############################################################################
    ...
    def get_average_time(self):
        ...
        avg_time_horse = {}
        for horse in self.race_dict:
            avg_time_horse[horse] = sum(self.race_dict[horse].value()) / len(self.race_dict[horse].value())

        return avg_time_horse
